...
librosa.display.specshow(Csync, bins_per_octave=BINS_PER_OCTAVE,
                         ...
                         x_coords=beat_times)
plt.title('Beat-synchronous Constant-Q Transform')
plt.tight_layout()
...
#plt.subplot(1, 2, 1)
#librosa.display.specshow(R, x_axis='time', y_axis='time', cmap='magma_r')
#plt.title('Binary recurrence (affinity)')
#plt.subplot(1, 2, 2)
#librosa.display.specshow(Rf, x_axis='time', y_axis='time', cmap='magma_r')
#plt.title('Binary recurrence enhanced')
#plt.tight_layout()
#plt.show()

lag = librosa.segment.recurrence_to_lag(Rf, pad=True)
plt.figure(figsize=(4, 4))
librosa.display.specshow(lag, x_axis='time', y_axis='lag')
...
#plt.figure(figsize=(12, 4))
#librosa.display.specshow(Msync, y_axis='linear', x_axis='time', x_coords=beat_times)
...
# A = mu * Rf + (1 - mu) * R_path # weighted
# A = Rf # First-set only
A = R_path # Second-set only
...
plt.figure(figsize=(8, 4))
plt.subplot(1, 2, 2)
librosa.display.specshow(evecs, cmap='inferno_r')
...
print('Bound beats: %s' % bound_beats)
